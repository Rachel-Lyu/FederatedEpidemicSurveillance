...
class cenDecen:
    def __init__(self, date_value, subTS, allocProp = None, growthRateThr = 20, pval_thr = 0.05, case_thr = 20, combinedPmethod = 'SS', window4Pval = 2, updating_period = 2, training_period = 4, share_lag = 1, rep_per_wk = 7):
...
if __name__ == '__main__':
    ...
    df_out.to_csv('claim_result_summary.csv')